class Tabs {
  constructor(element) {
    ...
    this.selectedTab = document.querySelectorAll('.tabs-link');
...
class TabLink {
  constructor(element) {
    ...
    this.element.addEventListener('click', event => this.select());
  }
...
const tab = tabsLinks.forEach(link => new Tabs(link));